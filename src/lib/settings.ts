...
const DEFAULT_HERO_SLIDES: HeroSlide[] = [
  {
    ...
    heading: {
      es: {
        line1: 'LA TECNOLOGÍA NO TRANSFORMA EMPRESAS.',
        line2: 'DISEÑAMOS LOS SISTEMAS DE IA',
        line3: 'QUE SÍ LO HACEN.',
        full: 'La tecnología no transforma empresas. Diseñamos los sistemas de IA que sí lo hacen.',
        dataText: 'CIBAI.Studio — Consultoría tecnológica en IA, automatización y software a medida para empresas',
      },
      ca: {
        line1: 'LA TECNOLOGIA NO TRANSFORMA EMPRESES.',
        line2: "DISSENYEM ELS SISTEMES D'IA",
        line3: 'QUE SÍ HO FAN.',
        full: "La tecnologia no transforma empreses. Dissenyem els sistemes d'IA que sí ho fan.",
